<template><div><h1 id="链表中指针的一些用法要点" tabindex="-1"><a class="header-anchor" href="#链表中指针的一些用法要点"><span>链表中指针的一些用法要点</span></a></h1>
<div class="language-c line-numbers-mode" data-highlighter="prismjs" data-ext="c"><pre v-pre><code><span class="line"><span class="token comment">/* 结构体不能含有同类型的结构，但是可以含有指向同类型结构的指针。这样的定义是定义一个链表的基础。 */</span><span class="token number">1</span> <span class="token keyword">typedef</span> <span class="token keyword">int</span> Element<span class="token punctuation">;</span></span>
...
<li>
<p>等号 = 左右 的 <code v-pre>p</code> 和 <code v-pre>p-&gt;next</code> 意义不同，要注意甄别；</p>
</li>
<li>
<p><code v-pre>pre </code> 单独出现的时候代表一个节点 ，如 <code v-pre>head</code>，就代表 <code v-pre>head节点</code>；</p>
</li>
<li>
...
<div class="language-c line-numbers-mode" data-highlighter="prismjs" data-ext="c"><pre v-pre><code><span class="line"><span class="token comment">/**</span>
