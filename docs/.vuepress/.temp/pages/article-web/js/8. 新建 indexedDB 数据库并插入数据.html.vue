<template><div><h1 id="新建-indexeddb-数据库并插入数据" tabindex="-1"><a class="header-anchor" href="#新建-indexeddb-数据库并插入数据"><span>新建 indexedDB 数据库并插入数据</span></a></h1>
<h3 id="一、什么叫数据库" tabindex="-1"><a class="header-anchor" href="#一、什么叫数据库"><span>一、什么叫数据库</span></a></h3>
<p>DB的全名是database，即数据库。</p>
<h3 id="二、数据库的种类" tabindex="-1"><a class="header-anchor" href="#二、数据库的种类"><span>二、数据库的种类</span></a></h3>
<p>数据库有两种类型，分别是关系型数据库和非关系型数据库。</p>
<ul>
<li>关系型数据库：<strong>Oracle</strong>、<strong>DB2</strong>、<strong>MicrosoftSQLServer</strong>、MicrosoftAccess、<strong>MySQL</strong>等。</li>
<li>非关系型数据库：NoSql、Cloudant、MongoDb、redis、HBase等。</li>
</ul>
<p>关系型数据库的优点：</p>
<ol>
<li>能够复杂查询：可以用SQL句子便捷的在一个表及多个表之间做复杂的数据查询。</li>
<li>事务支持性优秀：能够实现对于安全性要求很高的数据访问。</li>
</ol>
<p>非关系型数据库的优点：</p>
<ol>
<li>性能好：NOSQL是基于键值对的，可以想象成表中的主键和值的对应关系，并且不用通过SQL层的解析，因此性能表现优异。</li>
<li>可扩展性好：同样也是基于键值对，数据间耦合度低，因此很容易水平扩展。</li>
</ol>
<ul>
<li>SQL (Structured Query Language) 是一种数据库语言 。</li>
<li>就数据库类型而言，<strong>IndexedDB</strong> 不属于关系型数据库（不支持 SQL 查询语句），更接近 NoSQL 数据库。</li>
</ul>
<hr>
<h2 id="indexeddb-具有以下特点" tabindex="-1"><a class="header-anchor" href="#indexeddb-具有以下特点"><span>IndexedDB 具有以下特点</span></a></h2>
...
<ul>
<li><strong>数据库</strong>是一系列相关数据的容器。</li>
<li>每个数据库包含若干个<strong>对象仓库（object store）</strong>。它类似于关系型数据库的表格。</li>
<li>对象仓库保存的是<strong>数据记录</strong>。每条记录类似于关系型数据库的行，但是只有主键和数据体两部分。</li>
<li>数据库 &gt; 对象仓库 &gt; 数据记录</li>
</ul>
<h2 id="操作流程" tabindex="-1"><a class="header-anchor" href="#操作流程"><span>操作流程</span></a></h2>
<ol>
<li>
<h3 id="打开数据库-indexeddb-open" tabindex="-1"><a class="header-anchor" href="#打开数据库-indexeddb-open"><span>打开数据库： indexedDB.open()</span></a></h3>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre v-pre><code><span class="line">var version = 1;</span>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="https://img2020.cnblogs.com/blog/2194212/202112/2194212-20211206111952590-1861223178.png" alt="img"></p>
</li>
<li>
<h3 id="新建数据库" tabindex="-1"><a class="header-anchor" href="#新建数据库"><span>新建数据库：</span></a></h3>
<p>新建数据库与打开数据库是同一个操作。如果指定的数据库不存在，就会新建。</p>
<p>a. 新建对象仓库（即新建表）。</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre v-pre><code><span class="line">request.onupgradeneeded = function(e) {</span>
<span class="line">    db = e.target.result;</span>
<span class="line">    console.log("onupgrageneeded");</span>
...
<span class="line">}</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>c. 如果数据记录里面没有合适作为主键的属性，可以让 IndexedDB 自动生成主键（设置主键）。</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre v-pre><code><span class="line">var objectStore = db.createObjectStore("person", { autoIncrement: true }); //指定主键为一个递增的整数</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><p>d. 新建数据库后可以新建当前数据库的索引，使用索引可以更方便的查询数据。</p>
...
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>使用索引查询代码如下：</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre v-pre><code><span class="line">useIndex() {</span>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li>
<li>
<h3 id="新增数据" tabindex="-1"><a class="header-anchor" href="#新增数据"><span><strong>新增数据：</strong></span></a></h3>
<p>新增数据指的是向对象仓库写入数据记录。这需要通过事务完成。</p>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre v-pre><code><span class="line">var obj1 = {id:1,name:"张三",age:24,email:"zhangsan@foxmail.com"};</span>
...
<span class="line">}</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>注意：不加window.onload 可能存在异步问题，报undefined错误。<img src="https://img2020.cnblogs.com/blog/2194212/202112/2194212-20211206114145886-1075675017.png" alt="img"></p>
<p>执行过代码后如果对象仓库仍是空，刷新一下即可：</p>
<p><img src="https://img2020.cnblogs.com/blog/2194212/202112/2194212-20211206114019396-530379478.png" alt="img"></p>
<p><img src="https://img2020.cnblogs.com/blog/2194212/202112/2194212-20211206114026351-222139046.png" alt="img"></p>
</li>
</ol>
<hr>
<p>参考文章：</p>
