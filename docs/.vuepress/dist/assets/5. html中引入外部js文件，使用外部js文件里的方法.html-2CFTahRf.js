import{_ as n,c as e,b as a,o as l}from"./app-DyBO3kfI.js";const i={};function t(d,s){return l(),e("div",null,s[0]||(s[0]=[a(`<h1 id="html中引入外部js文件-使用外部js文件里的方法" tabindex="-1"><a class="header-anchor" href="#html中引入外部js文件-使用外部js文件里的方法"><span>html中引入外部js文件，使用外部js文件里的方法</span></a></h1><p>外部js文件1：</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">/**</span>
