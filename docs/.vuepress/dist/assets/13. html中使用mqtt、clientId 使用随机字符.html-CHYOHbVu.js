import{_ as s,c as e,b as l,o as i}from"./app-DyBO3kfI.js";const a={};function t(c,n){return i(),e("div",null,n[0]||(n[0]=[l(`<h1 id="html中使用mqtt、clientid-使用随机字符" tabindex="-1"><a class="header-anchor" href="#html中使用mqtt、clientid-使用随机字符"><span>html中使用mqtt、clientId 使用随机字符</span></a></h1><p><a href="https://github.com/mqttjs" target="_blank" rel="noopener noreferrer">MQTT.js</a> 是一个开源项目，支持 nodejs 和 Browser js ，这里对比一下 nodejs 和 Browser js 的用法： <code>注：nodejs是运行在webserver的js，Browser js意思是运行在浏览器上的js，也就是H5用到的js</code><code>注：目前项目方已经提供 CDN，不需要自己打包 https://unpkg.com/mqtt/dist/mqtt.min.js</code></p><p><strong>url：ws://xxxxx:port/mqtt</strong></p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">&lt;!DOCTYPE html&gt;</span>
